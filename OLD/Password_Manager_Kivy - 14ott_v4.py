...
# todo: inserire pulsante back sopra il recycleview
# todo: inserire un pulsante per uscire app.stop() o app.close() nella choicepage
# todo: inserire una progressbar nella funzione aggiungipassword in InserimentoDati
# todo: costruire la pagina con le quattro label per aggiornare i dati di un account: riciclare la pagina InserimentoDati imponendo di default la textinput (id: input_account) pari al nome dell'account scelto
