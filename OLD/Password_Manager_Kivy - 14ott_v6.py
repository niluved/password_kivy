...
# todo: per aggiornare i dati di un account: modificare la funzione reveal in choicepage2 provando a passrgli un parametro e mettendo un if alla fine: se metto 1 lancio la funzione così come è, se metto 2 cambio le ultime righe assegnando di default i valori decrittati ai vari textinput 
